 ...
 *   - {String} [decode]: optional, decode response to UTF-8 if Content-Type charset is different. 
...
exports.request = function (url, args, callback, context) {
  ...
  var res_end = function(chunks, size, res) {
    ...
    data = args.decode ? require('iconv-lite').decode(data, args.decode) : data
